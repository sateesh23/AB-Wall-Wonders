...
export class SanityService {
  ...
  private static convertToProjectData(sanityProject: SanityProject): ProjectData {
    return {
      ...
      thumbnail: sanityProject.image ? urlFor(sanityProject.image).url() : '/placeholder.svg',
      image: sanityProject.image ? urlFor(sanityProject.image).url() : '/placeholder.svg',
      images: sanityProject.images ? sanityProject.images.map(img => urlFor(img).url()) : [],
