  ...
  const wallpaperFAQs = [
    {
      ...
      answer:
        "We install 3D wallpapers, botanical, embossing, geometric, modern, mural, striped, and traditional wallpapers with premium quality materials and expert installation.",
    },
    {
      question: "How long does wallpaper last?",
      answer:
        "Our premium wallpapers come with a 5-year warranty and are designed to last 10+ years with proper care. They are moisture-resistant and fade-resistant.",
    },
    {
      question: "Can wallpapers be removed without damaging walls?",
      answer:
        "Yes, our wallpapers feature peel & replace technology that allows easy removal without damaging your walls.",
    },
    {
      question: "Do you provide custom wallpaper designs?",
      answer:
        "Yes, we offer custom wallpaper patterns and designs tailored to your specific requirements and interior design vision.",
    },
  ];
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-sage-600 max-w-3xl mx-auto">
                Choose from our premium range of wallpaper options, each
                designed for specific aesthetics and environments
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Easy removal and replacement without wall damage",
                  icon: RotateCcw,
                },
                {
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black via-black/80 to-transparent p-6">
                  ...
                  <p className="text-white/90 text-sm mb-4">
                    Waterproof vinyl flooring that complements your new
                    wallpapers perfectly
                  </p>
              ...
              <div className="relative bg-gradient-to-br from-green-700 via-green-600 to-green-800 rounded-3xl p-12 text-white">
                <div className="text-center">
                  ...
                  <p className="text-xl text-green-100 mb-12 max-w-3xl mx-auto">
                    Get a free consultation and quote for your wallpaper
                    project. Professional installation with 5-year warranty
                    included.
                  </p>
