  ...
  const projectsFAQs = [
    {
      ...
      answer:
        "Yes, our projects gallery showcases completed wallpaper, flooring, and blinds installations across Andhra Pradesh with before/after photos and detailed descriptions.",
    },
    {
      question: "Do you work on both residential and commercial projects?",
      answer:
        "Yes, we handle both residential homes and commercial spaces including offices, restaurants, hotels, and retail establishments.",
    },
    {
      question: "How long do your typical projects take?",
      answer:
        "Project duration varies by scope: wallpaper installations take 1-2 days, flooring 2-3 days, and blinds installation typically takes 1 day.",
    },
    {
      question: "Can you provide references from past clients?",
      answer:
        "Absolutely! We can provide references and testimonials from our satisfied clients across Andhra Pradesh upon request.",
    },
  ];
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <p className="text-xl md:text-2xl text-primary/70 max-w-2xl mx-auto">
                Professional Wallpapers, Blinds & Flooring Services across
                Andhra Pradesh
              </p>
