...
export default function BrandMetaTags({
  ...
  return (
    <Helmet>
      ...
      <meta name="brand-aliases" content={brandVariations.variations.join(", ")} />
      <meta name="brand-misspellings" content={misspellings.join(", ")} />
      
      {/* Service-Specific Brand Meta Tags */}
      <meta name="service-brand-names" content={serviceSpecificBrands?.join(", ")} />
      <meta name="location-brand-searches" content={locationBrands.join(", ")} />
      
      {/* Enhanced Brand Keywords */}
      <meta name="brand-keywords" content={`
      ...
      <meta name="phonetic-variations" content="A B Wall Wonders, ay bee wall wonders, ab wal wonders" />
      ...
      <meta name="entity-aliases" content={brandVariations.variations.join("|")} />
      
      {/* Social Media Brand Recognition */}
      <meta property="business:contact_data:company_name" content="AB Wall Wonders" />
      <meta property="business:contact_data:alternate_name" content="ABwallwonders" />
      <meta property="business:contact_data:brand_name" content="Wall Wonders" />
      
      {/* Search Engine Brand Signals */}
      <meta name="search-brand-terms" content={`
      ...
      <meta name="brand-specialization" content="Premium Wallpapers, Luxury Flooring, Custom Blinds" />
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          target: {
            "@type": "EntryPoint",
            urlTemplate: "https://ab-wall-wonders.vercel.app/?search={brand_query}"
          },
...
export const generateBrandTitle = (service: string, location: string = "Andhra Pradesh") => {
  const brandVariations = [
...
export const generateBrandDescription = (service: string, location: string = "Andhra Pradesh") => {
