        ...
        titleComponent={
          <>
            ...
            <p className="text-lg md:text-xl text-primary/80 max-w-3xl mx-auto mt-6 leading-relaxed">
              Over 1000 Projects completed across Andhra Pradesh. Expert
              wallpaper installation, smart blinds, and premium flooring
              solutions with 15+ years of experience.
            </p>
            ...
            <div className="mt-8 flex flex-col items-center space-y-4">
              ...
              <p className="text-xs text-primary/60 max-w-md text-center px-4">
                Trusted by 100+ families across Andhra Pradesh • 2+ years of
                proven expertise
              </p>
            </div>
          </>
