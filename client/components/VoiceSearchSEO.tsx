...
export default function VoiceSearchSEO({
  ...
  return (
    <Helmet>
      ...
      <meta name="conversational-keywords" content="find AB Wall Wonders, best wallpaper company, interior design near me, ABwallwonders location, Wall Wonders contact" />
      ...
      <meta name="business-hours" content="Monday-Saturday: 9:00 AM - 6:00 PM" />
...
export const generateVoiceSearchKeywords = (businessName: string, location: string, service?: string) => {
  const baseKeywords = [
    `Find ${businessName}`,
